...
OP_PUBKEY_SET = "pubkey_set"   # write your own age public key to the server directory
OP_PUBKEY_GET = "pubkey_get"   # ask for an address's public key (accounts on this server)
